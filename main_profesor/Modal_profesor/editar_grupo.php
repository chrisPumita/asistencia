<!-- Modal crear grupo -->
<div class="modal fade" id="modal_editaGrupo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="tituloModalGrupo">Editar detalles de grupo</h5>
                <button type="button" class="btn-close btnClose_modal" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body p-4 mt-1">
                <h6 class="mb-3">Llene los campos para editar el grupo</h6>
                <form id="frm_new_grpo">
                    ...
                    <div class="row mb-3">
                        <div class="col-12 col-md-6">
                            <div class="row mt-2">
                                <div class="col-3 col-md-4 creargrupo_center">
                    ...
                    <div class="row">
                        <div class="col">
                            <button type="submit" class="btn btn-success btn-sm mb-2">Actualizar</button>
                            <button type="submit" class="btn btn-success btn-sm mb-2">Actualizar y enviar invitaciones</button>
                        </div>
                    </div>
                </form>
            </div>
